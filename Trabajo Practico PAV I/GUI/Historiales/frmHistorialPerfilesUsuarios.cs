    ...
    public partial class frmHistorialPerfilesUsuarios : Form
    {
        ...
        private void CargarGrilla()
        {
            try
            {
                ...
                string consulta = "SELECT U.usuario as 'Ususario', P.nombre as 'Perfil', H.fecha as 'Fecha' FROM HistorialPerfilesUsuarios H JOIN Usuarios U ON h.id_usuario = U.id_usuario JOIN Perfiles P ON P.id_perfil = h.id_perfil";
